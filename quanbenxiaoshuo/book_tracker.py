...
from quanbenxiaoshuo.index_parser import IndexParser
from quanbenxiaoshuo.page_tracker import PageTracker
...
class Tracker(TrackerBase):
    ...
    def _need_read_page_content(self, response):
        ...
        m_time = datetime.datetime.strptime(last_modified,
    ...
    def _parse_url(self):
        self.prefix_ = 'quanbenxiaoshuo_' + Path(self.url_).parts[-2]
